...
sw install:release --release="5.4.1" --install-dir="/var/www/shopware" --shop-host="localhost" --db-host="shopware5-mysql" --db-user="app" --db-password="app" --db-name="shopware5" --admin-username="styla" --admin-password="styla" --admin-name="Styla Admin" --admin-email="support@styla.com"
