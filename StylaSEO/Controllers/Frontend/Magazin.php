...
class Shopware_Controllers_Frontend_Magazin extends Enlight_Controller_Action {
    ...
    public function preDispatch(Enlight_Event_EventArgs $args=null){
        ...
        if(!$this->_username) {
            die('No Styla Magazine ID set for Styla SEO plugin'); // TODO maybe something better than die, but then again since it's a required field this should never really be empty
        }
    }
